...
@section('title', 'Tambah Aturan Akses Baru')
        ...
        <div class="card-body">
            ...
            <form action="{{ route('access-rules.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: Member Reguler, Staf Pagi" required>
                </div>
                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="max_taps_per_day" id="max_taps_per_day" class="form-control" value="{{ old('max_taps_per_day') }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="max_taps_per_month" id="max_taps_per_month" class="form-control" value="{{ old('max_taps_per_month') }}" min="0">
                            <small class="form-text text-muted">Kosongkan jika tidak ada batasan.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="form-check form-check-inline mr-3">
                            <input class="form-check-input" type="checkbox" name="allowed_days[]" value="{{ $day }}" id="{{ $day }}" {{ old('allowed_days') && in_array($day, old('allowed_days')) ? 'checked' : '' }}>
